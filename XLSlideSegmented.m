...
- (CGRect)clickSelectShadowRectOfIndex:(NSInteger)index {
        return CGRectMake([_collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForRow:index inSection:0]].frame.origin.x, self.bounds.size.height - 2, ItemMaxScale*[self itemWidthOfIndexPath:[NSIndexPath indexPathForRow:index inSection:0]], 2);
...
//    NSLog(@"didScroll_____%@",NSStringFromCGRect(_shadow.frame));
}
...
- (CGRect)shadowRectOfIndex:(NSInteger)index {
      return CGRectMake([_collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForRow:index inSection:0]].frame.origin.x, self.bounds.size.height - 2, [_collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForRow:index inSection:0]].frame.size.width, 2);
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    XLSlideSegmentedItem *item = (XLSlideSegmentedItem*)[_collectionView cellForItemAtIndexPath:indexPath];
    item.transform = CGAffineTransformMakeScale(ItemMaxScale, ItemMaxScale);
